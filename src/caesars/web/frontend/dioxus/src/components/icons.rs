...
#[component]
pub fn Heart() -> Element {
    rsx! {
        svg { xmlns: "http://www.w3.org/2000/svg", view_box: "0 0 36 36",
            path {
                fill: "#DD2E44",
...
pub fn Padlock() -> Element {
    rsx! {
        svg {
            ...
            path { style: "fill:#e2a610", d: "M6.57 63.43h79.29" }
            path {
            ...
            radialGradient {
                ...
                r: "37.716",
                gradient_units: "userSpaceOnUse",
                stop { offset: ".156", style: "stop-color:#3d8192" }
                stop { style: "stop-color:#3d8192", offset: ".277" }
            }
            path {
                style: "fill:url(#b)",
